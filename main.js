...
// Duplicate cardsArray to create a match for each one
var gameGrid = cardsArray.concat(cardsArray);
// Randomize game grid on match load 
...
//  Create a section element and assign it to the variable of grid
...
// Loop through items in our cards array
...
var match = function(){
    ...
    // Loop through through the array like objects in the `selected` class
...
grid.addEventListener('click', function(event) {
    ...
    if (count < 2) {
          ...
          if (firstGuess !== '' && secondGuess !== '' ) {
            // and the firstGuess mathes secondGuess
            if (firstGuess === secondGuess) {
